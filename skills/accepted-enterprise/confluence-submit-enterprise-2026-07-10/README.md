<!-- Synced from Confluence page 6438158359: confluence-submit — Enterprise 2026-07-10 -->
...
**3a. Find candidates.** Call `getPagesInConfluenceSpace` (cloudId `20d966ed-3d3f-4c0c-b14b-c1dbb9bb6aa7`, spaceId `6386384916`) to list titles across the whole IAS space — not just a likely destination page, since an overlapping skill could live anywhere within IAS (Enterprise or any Team subpage). Also run `searchConfluenceUsingCql` with a couple of keyword variants pulled from the skill's core task (not just its literal name — two skills solving the same problem often have different names), always scoped to the IAS space with `space = "IAS"` in the CQL query (e.g. `space = "IAS" AND title ~ "[keyword]"`) — never search across all of Confluence. Skip structural pages (space homepage, "Enterprise Skills," "Team Skills," topic subpages like "Sales") — you're looking for actual skill pages.
...
1
8d106838-319e-4271-9149-e9939530fbdc
incomplete
...
2
eee7dd4a-7c15-4e59-ba3e-e01aae68b2c6
incomplete
...
5
a1d0180a-a5cb-43c5-9abc-6c8f3b8e264a
incomplete
...
6
b48265e7-501a-4e30-a3b0-71abfc45236c
incomplete
